...
export const reviews: Review[] = [
  {
    ...
    city: 'Tampa',
    rating: 5,
    text: 'Our dryer was taking three cycles to dry one load. After Dry Vent Tampa cleaned the vent, everything dried in one cycle. The technician was on time, professional, and showed me before and after photos. Massive difference.',
    source: 'Google',
    date: '2026-03-15',
  ...
  },
  {
    ...
    city: 'Clearwater',
    rating: 5,
    text: 'We manage 120 units and use Dry Vent Tampa for all of them. They are reliable, fairly priced, and their team is always professional. Best vendor we work with by a wide margin.',
    source: 'Google',
    date: '2026-03-02',
  ...
  },
  {
    ...
    city: 'New Tampa',
    rating: 5,
    text: 'Three other companies told me my vent run was too long for them to handle. Dry Vent Tampa came out, did the full 32 feet through two stories, and now my dryer works better than when it was new.',
    source: 'Google',
    date: '2026-03-22',
    service: 'Residential Cleaning',
  },
